...
code_repository_path = 'C:\\Users\\zimme\\OneDrive\\Documents\\heic'
output_file = 'output_main.txt'
ignore_patterns = ['venv', 'docs', '.css', '.gitattributes', '__pycache__', 'instance', 'web_handlers.py', 'tests', 'migrations', '.gitattributes', 'README.md', 'flask_stripe', 'dbc.py', 'run.py', '.git', 'docs', 'directory_markdown.py']
